package engineer.untitled.realm.http;

import engineer.untitled.realm.entity.Category;
...
public class CategoryController {
    ...
    public ResponseEntity<String> search(@RequestParam(value = "someEnum") Category someEnum) {
        return ResponseEntity.ok(someEnum.getName());
    }

    @RequestMapping(value = "/category/map", method = RequestMethod.GET)
    public Map<String, Map<String, Category>> map() {
        return new HashMap<>();
    }
